	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="index.html">
					<img alt="Logo" src="/assets/img/mainstay-logo.png" />
				</a>
			</div>
		...
		<!-- end:: Header Mobile -->
		<div class="kt-grid kt-grid--hor kt-grid--root" id="revenuePlusAPP">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				@include('layouts.partials.public.sidemenu')
								...
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="" class="kt-subheader__breadcrumbs-link">
											{{date('d F Y', strtotime($commission->comm_sdate)) . ' to ' . date('d F Y', strtotime($commission->comm_edate))}} </a>
										@endif
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('#database_listing').change(function(){
					location.href = "{{url('/public/change-db')}}/"+$(this).val()+"/{{$hash_id}}";
				})
			})
		</script>
	</body>
